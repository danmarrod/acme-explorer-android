...
public class FirebaseDatabaseService {
    ...
    public DatabaseReference getTrips(String tripId) {
        // Reference, ruta de la estructura de datos donde se encuentre el identificado
        return mDatabase.getReference("users/"+ userId + "/trips/" + tripId).getRef();
    }

    public DatabaseReference getTripsTitle(String tripId) {
        return mDatabase.getReference("users/"+ userId + "/trips/" + tripId + "/title").getRef();
    }
    ...
    public void saveTrips(Trip trip, DatabaseReference.CompletionListener completionListener) {
        // add to this a id autogenerated
        mDatabase.getReference("users/"+ userId + "/trips").push().setValue(trip, completionListener);
    }
